...
@section('body')
    ...
    <section style="padding-top: 50px">
        <div class="container" style="border:white 1px solid; border-radius: 50px; background-color: white;padding: 10px">
            ...
            <form method="POST" action="{{ route('password.update') }}" style="padding-bottom:15%;padding-top:15%; ">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                            name="password" required autocomplete="new-password" placeholder="Новый пароль">
                    ...
                    <div class="col-12">
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation"
                            required autocomplete="new-password" placeholder="Подтверждение пароля">
                    </div>
